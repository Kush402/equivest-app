...
export default function PropertyChartsSection({ data, purchasePrice }: PropertyChartsSectionProps) {
  return (
    <>
      <div>
        <h2 className="font-bold text-gray-900 mb-1" style={{ fontFamily: 'Syne, sans-serif' }}>Income Over Time</h2>
      ...
      <div>
        <h2 className="font-bold text-gray-900 mb-1" style={{ fontFamily: 'Syne, sans-serif' }}>Property Value Growth</h2>
