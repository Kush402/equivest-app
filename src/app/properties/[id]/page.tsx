        ...
        <div className="absolute bottom-0 left-0 right-0 px-4 pb-6 max-w-7xl mx-auto">
          <div className="flex items-end justify-between gap-4">
            <div>
              ...
              <h1 className="text-3xl md:text-5xl font-bold text-white leading-tight" style={{ fontFamily: 'Syne, sans-serif' }}>
                {property.name}
              </h1>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
              {metrics.map(m => (
                <div key={m.label} className={`${m.bg} rounded-2xl p-4 text-center`}>
                  <p className={`text-2xl font-bold ${m.color}`} style={{ fontFamily: 'Syne, sans-serif' }}>{m.value}</p>
            ...
            {property.status !== 'Coming Soon' && (
              <div className="bg-white rounded-2xl border border-gray-100 p-5 shadow-sm">
                <div className="flex justify-between items-center mb-3">
                  ...
                  <p className="text-3xl font-bold text-violet-600" style={{ fontFamily: 'Syne, sans-serif' }}>{property.funded}%</p>
                </div>
            ...
            <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
              <Tabs defaultValue="overview" className="w-full">
                ...
                <TabsContent value="overview" className="p-6">
                  <h2 className="font-bold text-gray-900 mb-3" style={{ fontFamily: 'Syne, sans-serif' }}>About this property</h2>
                ...
                <TabsContent value="financials" className="p-6">
                  <h2 className="font-bold text-gray-900 mb-4" style={{ fontFamily: 'Syne, sans-serif' }}>Financial Breakdown</h2>
                ...
                <TabsContent value="highlights" className="p-6">
                  <h2 className="font-bold text-gray-900 mb-4" style={{ fontFamily: 'Syne, sans-serif' }}>Property Highlights</h2>
